...
store.dispatch(addUser({ id: 6, name: 'Jenia' }))
store.dispatch(addUser({ id: 7, name: 'Roma' }))
store.dispatch(addUser({ id: 8, name: 'Tania' }))
store.dispatch(deleteUser(8))
store.dispatch(updateUser(7, { name: 'Kostia' }))
